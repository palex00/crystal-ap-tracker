...
SHOP_MAPPING = {
    ...
    ["EVENT_SEEN_MART_CERULEAN"] = "@JohtoKanto/Cerulean City/Poke Mart - Shop Items",
    ["EVENT_SEEN_MART_VERMILION"] = "@JohtoKanto/Vermilion City/Poke Mart - Shop Items",
    ...
    ["EVENT_SEEN_MART_ROOFTOP_SALE"] = "@JohtoKanto/Goldenrod City/Dept. Store - Rooftop Sale - Shop Items",
