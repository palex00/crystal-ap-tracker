...
-- === FREE FLY ===
Entry_point:connect_one_way(REGION_NEW_BARK_TOWN, "Fly to New Bark Town", function() return can_freefly("NewBark") end)
Entry_point:connect_one_way(REGION_CHERRYGROVE_CITY, "Fly to Cherrygrove City", function() return can_freefly("Cherrygrove") end)
Entry_point:connect_one_way(REGION_VIOLET_CITY, "Fly to Violet City", function() return can_freefly("Violet") end)
Entry_point:connect_one_way(REGION_AZALEA_TOWN, "Fly to Azalea Town", function() return can_freefly("Azalea") end)
Entry_point:connect_one_way(REGION_GOLDENROD_CITY, "Fly to Goldenrod City", function() return can_freefly("Goldenrod") end)
Entry_point:connect_one_way(REGION_ECRUTEAK_CITY, "Fly to Ecruteak City", function() return can_freefly("Ecruteak") end)
Entry_point:connect_one_way(REGION_OLIVINE_CITY, "Fly to Olivine City", function() return can_freefly("Olivine") end)
Entry_point:connect_one_way(REGION_CIANWOOD_CITY, "Fly to Cianwood City", function() return can_freefly("Cianwood") end)
Entry_point:connect_one_way(REGION_MAHOGANY_TOWN, "Fly to Mahogany Town", function() return can_freefly("Mahogany") end)
Entry_point:connect_one_way(REGION_LAKE_OF_RAGE, "Fly to Lake of Rage", function() return can_freefly("LakeOfRage") end)
Entry_point:connect_one_way(REGION_BLACKTHORN_CITY, "Fly to Blackthorn City", function() return can_freefly("Blackthorn") end)
Entry_point:connect_one_way(REGION_SILVER_CAVE_OUTSIDE, "Fly to Silver Cave", function() return can_freefly("SilverCave") end)
Entry_point:connect_one_way(REGION_PALLET_TOWN, "Fly to Pallet Town", function() return can_freefly("Pallet") end)
Entry_point:connect_one_way(REGION_VIRIDIAN_CITY, "Fly to Viridian City", function() return can_freefly("Viridian") end)
Entry_point:connect_one_way(REGION_PEWTER_CITY, "Fly to Pewter City", function() return can_freefly("Pewter") end)
Entry_point:connect_one_way(REGION_CERULEAN_CITY, "Fly to Cerulean City", function() return can_freefly("Cerulean") end)
Entry_point:connect_one_way(REGION_VERMILION_CITY, "Fly to Vermilion City", function() return can_freefly("Vermilion") end)
Entry_point:connect_one_way(REGION_LAVENDER_TOWN, "Fly to Lavender Town", function() return can_freefly("Lavender") end)
Entry_point:connect_one_way(REGION_CELADON_CITY, "Fly to Celadon City", function() return can_freefly("Celadon") end)
Entry_point:connect_one_way(REGION_SAFFRON_CITY, "Fly to Saffron City", function() return can_freefly("Saffron") end)
Entry_point:connect_one_way(REGION_CINNABAR_ISLAND, "Fly to Cinnabar Island", function() return can_freefly("Cinnabar") end)
Entry_point:connect_one_way(REGION_FUCHSIA_CITY, "Fly to Fuchsia City", function() return can_freefly("Fuchsia") end)
Entry_point:connect_one_way(REGION_ROUTE_23, "Fly to Indigo Plateau", function() return can_freefly("IndigoPlateau") end)
