...
NAMED_NODES["REGION_BLACKTHORN_GYM_1F:LOLA"]:connect_one_way(NAMED_NODES["REGION_BLACKTHORN_GYM_1F:CLAIR"], "TODOBYSNOWFLAV", function() return has("EVENT_BOULDER_IN_BLACKTHORN_GYM_2") end)
...
-- === REGION_ROUTE_4:WEST ===
NAMED_NODES["REGION_ROUTE_4:WEST"]:connect_one_way(NAMED_NODES["REGION_ROUTE_4:EAST"], "Route 4 Ledge Jump", function() return has("EVENT_CLEARED_ROUTE_4") end)
