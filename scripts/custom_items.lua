...
RED_REQ = BadgesGymsRequirement("Red Requirement", "red_requirement", 16, 16, "images/events/become_champion.png")
RADIO_REQ = BadgesGymsRequirement("Radio Tower Requirement", "tower_requirement", 7, 8, "images/events/become_champion.png")
SILVER_REQ = BadgesGymsRequirement("Mt. Silver Requirement", "mt_silver_requirement", 16, 16, "images/events/become_champion.png")
